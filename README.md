## teb_local_planner_tutorials (melodic) - 0.2.4-1

The packages in the `teb_local_planner_tutorials` repository were released into the `melodic` distro by running `/usr/bin/bloom-release teb_local_planner_tutorials --rosdistro melodic` on `Wed, 03 Jul 2019 11:47:07 -0000`
